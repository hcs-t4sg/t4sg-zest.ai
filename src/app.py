...
def zrp():
    ...
    preds_data = {'American Indian': str(preds[0][0]), 'Asian Pacific Islander': str(preds[0][1]), 'Black': str(preds[0][2]), 'Hispanic': str(preds[0][3]), 'White': str(preds[0][4]), 'Other': str(preds[0][5]), 'Multi': str(preds[0][6])}
